...
const PhotosInspector = () => {
  ...
  useEffect(function callback() {
    ...
    handleLoadMorePhotosAsync.current();
  }, []);
  ...
  const handleLoadMorePhotosAsync = useRef({})
    handleLoadMorePhotosAsync.current = async () => {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center">
        <button
          onClick={handleLoadMorePhotosAsync.current}
...
export default PhotosInspector;
